...
(() => {
  ...
  const heToEn = {
    ...
    'עוזר התכנון של WedWise': 'WedWise planning assistant',
    'שאלון קצר, דוח מותאם': 'Short questionnaire, tailored report',
    'מלאו את השלבים בקצב שלכם. התשובות יעזרו לנו להבין תקציב, אזור, סגנון והשראה, ולהפיק עבורכם כיוון תכנון ברור ומותאם אישית.': 'Fill out the steps at your own pace. Your answers help us understand your budget, region, style, and inspiration, then create a clear personalized planning direction.',
    ...
    'סגירת המדריך': 'Close guide',
    'רשימת בדיקה קצרה': 'Short checklist',
    'מדריך WedWise': 'WedWise guide',
    'פתחו טיפ קצר': 'Open quick tip',
    'קראו את המדריך': 'Read the guide',
    'פתחו טיפ': 'Open tip',
    'פתחו מדריך': 'Open guide',
    'נושאים מרכזיים': 'Main topics',
    'זוג מתכנן חתונה עם טבעות ופרחים': 'Couple planning a wedding with rings and flowers',
    'זוג ביום החתונה': 'Couple on their wedding day',
    'חופה וסידור חתונה באולם': 'Ceremony canopy and wedding setup in a venue',
    'שולחן חתונה מעוצב עם פרחים': 'Designed wedding table with flowers',
    'חתונה עם אורחים וספקים בפעולה': 'Wedding with guests and suppliers at work',
    'זוג מצולם ביום החתונה': 'Couple photographed on their wedding day',
    'קבלת פנים בחתונה עם תאורה חמה': 'Wedding reception with warm lighting',
    'פרחים בהירים לעיצוב חתונה': 'Light flowers for wedding design',
    'זוג בחתונה בשטח פתוח': 'Couple at an outdoor wedding',
    'שולחן אוכל חגיגי באירוע': 'Festive event dining table',
    'הכנות אחרונות לפני חתונה': 'Final preparations before a wedding',
    'טקס חתונה אינטימי': 'Intimate wedding ceremony',
    'אורחים רוקדים בחתונה': 'Guests dancing at a wedding',
    'ניווט שאלות': 'Question navigation',
    'סגנון חתונה': 'Wedding style',
    'סוגי קישורי השראה לדוגמה': 'Example inspiration link types',
    'זוג בחתונה אלגנטית': 'Couple at an elegant wedding',
    'ערכת חתונה אלגנטית': 'Elegant wedding set',
    'חתונה אלגנטית': 'Elegant wedding',
    'תכנון חתונה': 'Wedding planning',
    'תכנון חכם עם בינה מלאכותית': 'Smart planning with artificial intelligence',
    'עברו בין הכלים של WedWise בלי לצאת מהחוויה.': 'Move between WedWise tools without leaving the experience.',
